...
function Careers() {
  ...
  return (
    <main>
          ...
          <div className="dept-grid">
            {DEPARTMENTS.map((d) => (
              ...
              >
                ...
                <h4>{d.title}</h4>
                <p>{d.desc}</p>
                <span className="career-apply">{form.dept === d.id ? <><i className="fas fa-check"></i> Selected</> : <>Apply <i className="fas fa-arrow-right"></i></>}</span>
              </article>
            ))}
          </div>
      ...
      .career-apply{ display:inline-flex; align-items:center; gap:7px; margin-top:12px; font-size:13px; font-weight:700; color:var(--purple); }
