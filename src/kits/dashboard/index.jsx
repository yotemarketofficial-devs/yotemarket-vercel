...
const SCREENS = { overview:Overview, pos:Pos, assistant:Assistant, insight:Insight, products:Products, feed:FeedManager, sales:Sales, wallet:Wallet, chat:Chat, subscription:Subscription, settings:Settings };
const LABELS = { overview:'Overview', pos:'Point of sale', assistant:'YoteAI', insight:'YoteMarket Insight', products:'My Products', feed:'YoteFeed', sales:'Sales', wallet:'Wallet', chat:'Chats', subscription:'Subscription', settings:'Settings' };
